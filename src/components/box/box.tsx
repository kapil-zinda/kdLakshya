...
import { Countdown } from "@/app/todo/challenges/countdown";
...
const Box = () => {
  ...
  const urgentTasks = tasks.filter((task) => task.priority === "important" && task.need === "urgent");
  const notUrgentTasks = tasks.filter((task) => task.priority === "important" && task.need === "not-urgent");
  const importantTasks = tasks.filter((task) => task.priority === "not-important" && task.need === "urgent");
  const notImportantTasks = tasks.filter(
    (task) => task.priority === "not-important" && task.need === "not-urgent"
  );
  return (
