          ...
          <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <li className="me-2">
              <a
                ...
                className={`inline-flex items-center justify-center p-4 border-b-2 ${gridView === 'overview'
              ...
              >
                <svg
                  className={`w-4 h-4 me-2 ${gridView === 'overview'
            ...
            <li className="me-2">
              <a
                ...
                className={`inline-flex items-center justify-center p-4 border-b-2 ${gridView === 'users'
                    ? 'text-blue-600 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group'
                    : 'border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group'
                  }`}
              >
                <svg
                  className={`w-4 h-4 me-2 ${gridView === 'users'
                      ? 'text-blue-600 dark:text-blue-500'
                      : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'
                    } `}
                  //aria-hidden="true"
            ...
            <li className="me-2">
              <a
                ...
                className={`inline-flex items-center justify-center p-4 border-b-2 ${gridView === 'teams'
                    ? 'text-blue-600 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group'
                    : 'border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group'
                  }`}
              >
                <svg
                  className={`w-4 h-4 me-2 ${gridView === 'teams'
                      ? 'text-blue-600 dark:text-blue-500'
                      : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'
                    } `}
                  //aria-hidden="true"
