          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <button
                ...
                className="mr-4 text-muted-foreground hover:text-foreground cursor-pointer"
                aria-label="Go back"
                type="button"
              >
                <svg
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {teacherData.type && (
                  <div>
                    ...
                    <div className="px-3 py-2 bg-muted border border-border rounded-md text-foreground capitalize">
                      {teacherData.type}
                    </div>
                  </div>
                )}
